  ...
  return (
    <section>
      <div className="grid grid-cols-1 lg:grid-cols-12">
        ...
        className="col-span-7 place-self-center lg:place-self-start text-center lg:ml-14 lg:text-left h-full flex flex-col ">
          ...
          <div>
            <button className="px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-500 via-primary-500 to-secondary-500 hover:bg-slate-200 text-white">
              <Link to="contact" smooth={true} duration={300}>Hire Me</Link>
            ...
            <button className="px-1 py-1 w-full sm:w-fit rounded-full  bg-gradient-to-br from-blue-500 via-primary-500 to-secondary-500 hover:bg-slate-800 text-white  mt-3 ">
              <a  href="/files/ANVARSHA S _RE2_2024.pdf"
              download className="block bg-[#121212] hover:bg-slate-800 rounded-full px-5 py-2">
                Download CV
              </a>
            </button>
          </div>
